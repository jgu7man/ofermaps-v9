...
export class RegistEmpresaComponent implements OnInit {
  drop: boolean = true;
  open: any;
  ...
  async onSubmit() {
    ...
    if (this.otraCategoria) {
      ...
      this._muestra.saveEmpresa(this.empresa, this.imagenCargada); //Guardar empresa
